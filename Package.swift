...
let SDKMachineLearningChecksum = "2c6b955c2278d3389ea05314a24608c18c280858a523395d2b295a82f18bc97c"
...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "\(hostingUrl)/machine-learning/\(SDKMachineLearningVersion)/spm/AmazonChimeSDKMachineLearning-0.3.0.2.zip",
