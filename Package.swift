...
let SDKMachineLearningChecksum = "79c48bda057948ffce0aaac7b7919eddff1ae46692a4175a5789ebd4c26321e0"
...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "\(hostingUrl)/machine-learning/\(SDKMachineLearningVersion)/spm/AmazonChimeSDKMachineLearning-0.3.0.10.zip",
