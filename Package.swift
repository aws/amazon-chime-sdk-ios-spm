...
let SDKMachineLearningChecksum = "25be6dbce2ebfe5b1cef10d5d2b0e50fd4f47e2760ca83bfb999def328a51ff2"
...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "\(hostingUrl)/machine-learning/\(SDKMachineLearningVersion)/spm/AmazonChimeSDKMachineLearning-0.3.0.5.zip",
