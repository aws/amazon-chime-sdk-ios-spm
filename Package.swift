...
let SDKMachineLearningChecksum = "7c08c55f369150552a06e2ca6d374ddcb8426b003163158e797173268220c9b2"
...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "\(hostingUrl)/machine-learning/\(SDKMachineLearningVersion)/spm/AmazonChimeSDKMachineLearning-0.3.0-7.zip",
