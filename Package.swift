...
let SDKMachineLearningChecksum = "8b14d3b677cb9fedba9bc25086b19a70cad6fc7f99d3453b5dc7eceba8af8fae"
...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "\(hostingUrl)/machine-learning/\(SDKMachineLearningVersion)/spm/AmazonChimeSDKMachineLearning-0.3.0-8.zip",
